...
const ProductsList = ({ onEdit }) => {
  const { products, loading, getAllProducts, deleteProduct, toggleFeaturedProduct } =
    useProductStore();
  ...
  if (loading) {
    return (
      <div className="bg-white shadow-lg rounded-lg max-w-4xl mx-auto p-8 text-center">
        Loading products...
      </div>
    );
  }
