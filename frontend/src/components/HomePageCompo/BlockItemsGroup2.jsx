...
import { TECH_ITEMS } from "../../utils/HomeMockData";
...
export default function BlockItemsGroup2() {
  return (
    <div className="w-full max-w-[1180px] flex flex-col md:flex-row border border-gray-300 rounded-md bg-white overflow-hidden mt-5 shadow-sm">
      {/* Left Section: Banner */}
      <div className="w-full md:w-[280px] min-h-[257px] relative group h-[200px] md:h-auto bg-blue-50 flex items-center justify-center">
        <img
          className="absolute inset-0 w-full h-full object-cover transition-opacity duration-500"
          src="/Image/Esection.png"
          alt="Consumer electronics category"
